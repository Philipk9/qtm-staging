...
/////////////-----------CTA EFFECT ------------//////////
  ...
  $("#open_offcanvas2").click(function () {
    $('.offcanvas__area').css('opacity', '1');
    $('.offcanvas__area').css('visibility', 'visible');
  });
  $("#close_offcanvas").click(function () {
  ...
  if (device_width > 100) {
    ...
    splitTitleLines.forEach(splitTextLine => {
      ...
      tl.from(itemSplitted.lines, { duration: 1, delay: 0.1, opacity: 0, rotationX: -30, force3D: true, transformOrigin: "top center -50", stagger: 0.1 });
    });
    /////////////////////////////////////////////////////
  ...
  if (radio_buttons) {
    radio_buttons.addEventListener('hover', function () {
